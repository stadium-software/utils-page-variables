...
There is no timeout when using this method for storing values. The values are stored in the DOM and are available until the page is closed or refreshed.

To store values across pages, you can use the [Application Variables](https://github.com/stadium-software/utils-body-variables) module. 
